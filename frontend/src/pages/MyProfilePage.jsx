...
function MyProfilePage() {
  ...
  return (
    ...
    >
      ...
      <div
        id="body"
        className="flex flex-grow flex-col border border-dashed border-red-600 md:flex-row"
      >
        {/* Sidebar */}
        <div
          id="sidebar"
        ...
        >
          <div className="my-4 rounded-md p-4 hover:bg-[#A3B18A]">
            <button
              ...
              className="flex items-center font-mono text-xl"
            >
              <svg
        ...
        {/* Horizontal tabs bar */}
        <div className="mt-2 flex justify-around rounded-full bg-[#DAD7CD] p-2 md:hidden">
          <button
            onClick={() => setTabValue(1)}
